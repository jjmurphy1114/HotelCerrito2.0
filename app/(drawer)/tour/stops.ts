...
export const descriptionsAudioMap: Record<string, Record<string, any>> = {
  en: {
    start: require('../../../assets/audio/en/descriptions/central_map.mp3'),
...
export const directionsAudioMap: Record<string, Record<string, any>> = {
  en: {
    ...
    start: require('../../../assets/audio/en/descriptions/central_map.mp3'),
    mapa_central: require('../../../assets/audio/en/descriptions/central_map.mp3'),
    capilla: require('../../../assets/audio/en/descriptions/central_map.mp3'),
    cancha: require('../../../assets/audio/en/descriptions/central_map.mp3'),
    sector_academico: require('../../../assets/audio/en/descriptions/central_map.mp3'),
    patio_central: require('../../../assets/audio/en/descriptions/central_map.mp3'),
    comedor: require('../../../assets/audio/en/descriptions/central_map.mp3'),
    CPA: require('../../../assets/audio/en/descriptions/central_map.mp3'),
    fabrica_de_queso: require('../../../assets/audio/en/descriptions/central_map.mp3'),
    CPV: require('../../../assets/audio/en/descriptions/central_map.mp3'),
    piscina: require('../../../assets/audio/en/descriptions/central_map.mp3'),
    hotel: require('../../../assets/audio/en/descriptions/central_map.mp3'),
